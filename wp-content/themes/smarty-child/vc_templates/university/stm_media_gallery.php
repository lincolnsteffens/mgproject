							...
							if( !empty( $item_img_id ) && $item_img_id > 0 ) : ?>
								...
								<?php
									if( $view_type == 'masonry' ) {
										...
										$stm_post_class = array( 'stm-media-gallery__item-col', 'col-md-3 col-sm-6 col-xs-12', 'media-type-' . $media_type );
								...
								<div class="stm-media-gallery__item">
									...
									<?php elseif( $media_type == 'image' ) : ?>
										...
										<?php if( !empty( $item_img_src[0] ) ) : ?>
											<a href="<?php echo esc_url( $item_img_src[0] ); ?>" class="stm-media-gallery__item-fancybox"><i class="stm-icon stm-icon-media-loupe"></i></a>

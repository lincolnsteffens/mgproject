					...
					<td class="product-name" data-title="<?php esc_attr_e( 'Product', 'smarty' ); ?>">
						<?php
							...
							if ( ! $_product->is_visible() ) {
								...
								printf( '<a class="product-thumbnail" href="%s">%s</a>', esc_url( $_product->get_permalink( $cart_item ) ), $thumbnail );
							}
						?>
						<div class="product-name-title">
                            <div class="hidden woocommerce_product__category">
                                <?php echo $terms = get_the_term_list( $_product->id, 'product_cat'); ?>
                            </div>
							<?php
								if ( ! $_product->is_visible() ) {

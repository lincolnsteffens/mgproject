...
if( function_exists( 'vc_set_default_editor_post_types' ) ){
	vc_set_default_editor_post_types( array( 'page', 'post', 'stm_sidebar', 'stm_course', 'stm_footer', 'stm_teacher', 'stm_event', 'stm_donation', 'stm_administrator' ) );
}
		...
		function smarty_vc_map_shortcodes() {
			...
			vc_map( array(
				...
				'params'      => array(
                    ...
                    array(
                        'type' => 'checkbox',
                        'heading' => esc_html__( 'More link', 'smarty' ),
                        'param_name' => 'title_more_link_enable'
                    ),
					array(
						'type'       => 'dropdown',
                    ...
                    array(
                        "type" => "vc_link",
                        "heading" => esc_html__('More link', 'smarty'),
                        "param_name" => "title_more_link",
                        'description' => esc_html__('Enter link more', 'smarty'),
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Font size', 'smarty' ),
                        'param_name' => 'title_more_link_font_size',
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        'type' => 'dropdown',
                        'heading' => esc_html__( 'Font weight', 'smarty' ),
                        'param_name' => 'title_more_link_font_weight',
                        'value' => array(
                            esc_html__( 'Choose', 'smarty' ) => '',
                            esc_html__( 'Thin', 'smarty' ) => 100,
                            esc_html__( 'Light', 'smarty' ) => 300,
                    ...
                    array(
                        ...
                        'param_name' => 'title_more_link_font_style',
                        'value' => array(
                            esc_html__( 'Choose', 'smarty' ) => '',
                            esc_html__( 'Normal', 'smarty' ) => 'normal',
                            esc_html__( 'Italic', 'smarty' ) => 'italic'
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Margin top', 'smarty' ),
                        'param_name' => 'title_more_link_margin_t',
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        ...
                        'param_name' => 'title_more_link_margin_r',
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        ...
                        'param_name' => 'title_more_link_margin_l',
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Margin bottom', 'smarty' ),
                        'param_name' => 'title_more_link_margin_b',
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        ...
                        'param_name' => 'title_more_color',
                        'value' => array(
                            esc_html__( 'Dark-blue', 'smarty' ) => 'dark-blue',
                            esc_html__( 'White', 'smarty' ) => 'white',
                            esc_html__( 'Dark-red', 'smarty' ) => 'red',
                            esc_html__( 'Custom', 'smarty' ) => 'custom'
                        ),
                        'dependency' => array( 'element' => 'title_more_link_enable', 'value' => 'true' ),
                        'group' => esc_html__('More link', 'smarty')
                    ...
                    array(
                        ...
                        'param_name' => 'title_more_color_custom',
                        'dependency' => array( 'element' => 'title_more_color', 'value' => 'custom' ),
                        'group' => esc_html__('More link', 'smarty')
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__( 'Separator - Color', 'smarty' ),
                        'param_name' => 'title_more_sep_color',
                        'value' => array(
                            esc_html__( 'Dark-blue', 'smarty' ) => 'dark-blue',
                            esc_html__( 'White', 'smarty' ) => 'white',
                            esc_html__( 'Dark-red', 'smarty' ) => 'red'
			...
			vc_map( array(
				...
				'params'      => array(
					...
					array(
						...
						'param_name' => 'btn_color',
						'value' => array(
							esc_html__( 'Red', 'smarty' )   => 'red',
							esc_html__( 'Red- Text White', 'smarty' )   => 'red-secondary',
							esc_html__( 'Blue', 'smarty' )   => 'blue',
                    ...
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Padding bottom', 'smarty' ),
                        'param_name' => 'btn_custom_padd_b',
                        'dependency' => array( 'element' => 'btn_size', 'value' => 'size-custom' )
                    ),
					array(
						'type'       => 'textfield',
                    ...
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Border radius', 'smarty' ),
                        'param_name' => 'btn_custom_border_radius',
                        'dependency' => array( 'element' => 'btn_size', 'value' => 'size-custom' )
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__( 'Text transform', 'smarty' ),
                        'param_name' => 'btn_transform',
                        'value' => array(
                            esc_html__( 'Normal', 'smarty' ) => 'normal',
                            esc_html__( 'Uppercase', 'smarty' ) => 'uppercase'
                        ),
                        'dependency' => array( 'element' => 'btn_size', 'value' => 'size-custom' )
                    ),
					array(
			...
			vc_map( array(
					...
					'params'      => array(
							...
							array(
								...
								'value' => array(
									esc_html__( 'Transparent', 'smarty' )  => 'transparent',
									esc_html__( 'White', 'smarty' )  => 'white',
                            ...
                            array(
                                'type' => 'attach_image',
                                'heading' => esc_html__( 'Background', 'smarty' ),
			...
			if( !empty( $post_categories ) && ! is_wp_error( $post_categories ) ) {
				foreach( $post_categories as $post_category ) {
					$post_categories_list[$post_category->name] = $post_category->term_id;
				}
			}
				...
				'params'      => array(
					...
					array(
						...
						'value' => array(
							...
							esc_html__( 'Small Grid', 'smarty' ) => 'small_grid'
						)
					),
					array(
						'type'       => 'dropdown',
                ...
                'params'      => array(
                    array(
                        ...
                        'value' => array(
                            esc_html__( 'Grid', 'smarty' ) => 'grid',
                            esc_html__( 'List', 'smarty' ) => 'list',
                            esc_html__( 'Grid2', 'smarty' ) => 'grid2',
                            esc_html__( 'List2', 'smarty' ) => 'list2'
                        )
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__( 'Column count', 'smarty' ),
                        'param_name' => 'column_count',
                        'value' => array(
                            esc_html__( 'Two columns', 'smarty' ) => '6',
                            esc_html__( 'Three columns', 'smarty' ) => '4'
                        ),
                        'dependency' => array( 'element' => 'view_style', 'value' => 'grid2' ),
                    ),
                    array(
                        'type'       => 'dropdown',
                        'heading'    => esc_html__( 'Column count', 'smarty' ),
                        'param_name' => 'column_count_list',
                        'value' => array(
                            esc_html__( 'One columns', 'smarty' ) => '12',
                            esc_html__( 'Two columns', 'smarty' ) => '6'
                        ),
                        'dependency' => array( 'element' => 'view_style', 'value' => 'list2' ),
                    ),
                    array(
                        'type'       => 'dropdown',
                    ...
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Box - Margin bottom', 'smarty' ),
                        'param_name' => 'box_margin_b',
                        'dependency' => array( 'element' => 'view_style', 'value' => array('grid2', 'list2') ),
                    ),
                    array(
                        'type'       => 'checkbox',
                        'heading'    => esc_html__( 'Thumbnails', 'smarty' ),
                        'param_name' => 'thumbnail_enable',
                        'dependency' => array( 'element' => 'view_style', 'value' => array('grid2', 'list2') ),
                    ),
                    array(
                        'type'       => 'checkbox',
                    ...
                    array(
                        'type'       => 'checkbox',
                        'heading'    => esc_html__( 'Content style', 'smarty' ),
                        'param_name' => 'content_style_enable'
                    ),
                    array(
                        'type'       => 'colorpicker',
                        'heading'    => esc_html__( 'Content box color', 'smarty' ),
                        'param_name' => 'content_color_custom',
                        'dependency' => array( 'element' => 'content_style_enable', 'value' => 'true' ),
                        'group' => esc_html__('Content style', 'smarty')
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Padding Top', 'smarty' ),
                        'param_name' => 'content_padding_t',
                        'dependency' => array( 'element' => 'content_style_enable', 'value' => 'true' ),
                        'group' => esc_html__('Content style', 'smarty')
                    ),
                    array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Margin bottom', 'smarty' ),
                        'param_name' => 'content_margin_b',
                        'dependency' => array( 'element' => 'content_style_enable', 'value' => 'true' ),
                        'group' => esc_html__('Content style', 'smarty')
                    ),
                    array(
                        'type'       => 'colorpicker',
                        'heading'    => esc_html__( 'Meta color', 'smarty' ),
                        'param_name' => 'meta_color_custom',
                        'dependency' => array( 'element' => 'content_style_enable', 'value' => 'true' ),
                        'group' => esc_html__('Content style', 'smarty')
                    ),
                    array(
                        'type'       => 'colorpicker',
                        'heading'    => esc_html__( 'Meta icons color', 'smarty' ),
                        'param_name' => 'meta_icons_color_custom',
                        'dependency' => array( 'element' => 'content_style_enable', 'value' => 'true' ),
                        'group' => esc_html__('Content style', 'smarty')
                    ),
                    array(
			...
			vc_map( array(
				...
				'params'   => array(
					...
					array(
						...
						'heading'    => esc_html__( 'Description', 'smarty' ),
						'param_name' => 'descr',
						'dependency' => array( 'element' => 'view_style', 'value' => array( 'style-1', 'style-4', 'style-3' ) )
					),
					array(
						'type'       => 'dropdown',
						'heading'    => esc_html__( 'Alignment', 'smarty' ),
					...
					array(
						...
						'dependency' => array( 'element' => 'view_style', 'value' => array( 'style-4', 'style-3' ) )
					),
					array(
						'type'       => 'textfield',
					...
					'params'   => array(
							array(
                                ...
                                'value' => array(
                                        ...
                                        esc_html__( 'Caption small', 'smarty' ) => 'caption_small'
                                )
							),
							array(
									'type' => 'attach_image',
                            ...
                            array(
                                'type'       => 'textfield',
                                'heading'    => esc_html__( 'Link Title', 'smarty' ),
            ...
            // Administrator - List
            vc_map( array(
                'name'        => esc_html__( '(STM) Administrators - List', 'smarty' ),
                'base'        => 'stm_administrators',
                'category'    => esc_html__( 'STM', 'smarty' ),
                'params'      => array(
                    array(
                        'type' => 'textfield',
                    ...
                    array(
                        'type' => 'checkbox',
                        'heading' => esc_html__( 'Socials', 'smarty' ),
                        'param_name' => 'socials_enable',
                        'admin_label' => true,
                    ),
                    array(
                        'type'       => 'css_editor',
            ...
            vc_map( array(
                'name'     => esc_html__( '(STM) Administrator - Contact details', 'smarty' ),
                'base'     => 'stm_administrator_contact_details',
                'category' => esc_html__( 'STM', 'smarty' ),
                'params'   => array(
                    array(
                        'type'       => 'textarea',
                        'heading'    => esc_html__( 'Address', 'smarty' ),
                        'param_name' => 'administrator_address'
                    ),
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Telephone', 'smarty' ),
                        'param_name' => 'administrator_tel'
                    ),
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Skype', 'smarty' ),
                        'param_name' => 'administrator_skype'
                    ),
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Email', 'smarty' ),
                        'param_name' => 'administrator_email'
                    ),
                    array(
                        'type'       => 'vc_link',
                        'heading'    => esc_html__( 'URL', 'smarty' ),
                        'param_name' => 'administrator_url'
                    ),
                    array(
                        'type'       => 'css_editor',
                        'heading'    => esc_html__( 'Css', 'smarty' ),
            ...
            // More
            vc_map( array(
                'name'     => esc_html__( '(STM) Link More', 'smarty' ),
                'base'     => 'stm_more',
                'category' => esc_html__( 'STM', 'smarty' ),
                'params'   => array(
                    array(
            ...
            //Timeline
            vc_map( array(
                'name' => __( '(STM) Timeline', 'smarty' ),
                'base' => 'stm_timeline',
                'category' => __( 'STM', 'smarty' ),
                ...
                'params' => array(
                    array(
                        'type'       => 'textfield',
                        'heading'    => __( 'Slider Width', 'smarty' ),
                        'param_name' => 'slider_width'
                    ),
                    array(
                        'type'       => 'css_editor',
                        'heading'    => __( 'Css', 'smarty' ),
                        'param_name' => 'css',
                        'group'      => __( 'Design options', 'smarty' )
                    )
                ),
                "js_view" => 'VcColumnView'
            ) );
            ...
            vc_map( array(
                ...
                "params" => array(
                    array(
                        'type' => 'attach_image',
                        'heading' => __( 'Image', 'smarty' ),
                        'param_name' => 'img_id'
                    ),
                    array(
                        'type'        => 'textfield',
                        'heading'     => __( 'Size', 'smarty' ),
                        'param_name'  => 'img_size',
                        'description' => __( 'Image size. Example: 400x500', 'smarty' )
                    ),
                    array(
                        "type" => 'textfield',
                        "heading" => __('Title', 'smarty'),
                        "param_name" => 'title',
                        'holder' => 'div'
                    ),
                    array(
                        "type" => 'textarea_html',
                        "heading" => __('Text', 'smarty'),
                        "param_name" => 'content'
                    )
                )
            ) );
			...
			vc_map( array(
				...
				'params'   => array(
					...
					array(
						'type'       => 'checkbox',
						'heading'    => esc_html__( 'Contact Photo - Enable', 'smarty' ),
						'param_name' => 'contact_photo_enable'
					),
                    array(
                        'type' => 'attach_image',
                        'heading' => esc_html__( 'Photo', 'smarty' ),
                        'param_name' => 'contact_photo',
                        'dependency' => array( 'element' => 'contact_photo_enable', 'value' => 'true' ),
                        'group'      => esc_html__( 'Photo', 'smarty' )
                    ),
					array(
						'type'       => 'css_editor',
						'heading'    => esc_html__( 'Css', 'smarty' ),
            ...
            // Contact Details
            vc_map( array(
                'name'     => esc_html__( '(STM) Contact details', 'smarty' ),
                'base'     => 'stm_contact_details',
                'category' => esc_html__( 'STM', 'smarty' ),
                'params'   => array(
                    array(
                        'type'       => 'textarea',
                    ...
                    array(
                        'type'       => 'textfield',
                        'heading'    => esc_html__( 'Work Schedule', 'smarty' ),
            ...
            // Media Gallery - Photo
            vc_map( array(
                'name'        => esc_html__( '(STM) Media Gallery - Photo', 'smarty' ),
                'base'        => 'stm_mg_photo',
                'category'    => esc_html__( 'STM', 'smarty' ),
                'params'      => array(
                    array(
                        'type'       => 'checkbox',
                        'heading'    => esc_html__( 'Carousel', 'smarty' ),
                        'param_name' => 'carousel_enable'
                    ),
                    array(
                        "type" => "textfield",
                        "heading" => esc_html__('Carousel height', 'smarty'),
                        "param_name" => "carousel_height",
                        'description' => esc_html__( 'Carousel height. Example: auto or 400px;', 'smarty' ),
                        'dependency' => array( 'element' => 'carousel_enable', 'value' => 'true' )
                    ),
                    array(
                        'type'       => 'css_editor',
                        'heading'    => esc_html__( 'Css', 'smarty' ),
			...
			vc_map( array(
				...
				'params'      => array(
                    ...
                    array(
                        'type'       => 'checkbox',
                        'heading'    => esc_html__( 'Small Grid', 'smarty' ),
                        'param_name' => 'small_grid_enable'
                    ),
					array(
						'type'       => 'css_editor',
						'heading'    => esc_html__( 'Css', 'smarty' ),
			...
			if( !empty( $locations ) ) {
				foreach( $locations as $location => $location_name ) {
					$registered_locations[$location] = $location_name;
				}
			}
			...
			if( !empty( $menu_locations ) && ! is_wp_error( $menu_locations ) ) {
				foreach( $menu_locations as $menu_location => $menu_id ) {
					if( isset( $registered_locations[$menu_location] ) && !empty( $registered_locations[$menu_location] ) ) {
						$menu_location_name = $registered_locations[$menu_location];
						$custom_menus[$menu_location_name] = $menu_location;
					}
				}
			}
            ...
            vc_map( array(
                'name' => esc_html__( '(STM) MailChimp', 'smarty' ),
                'base' => 'stm_mailchimp',
                'category' => esc_html__( 'STM', 'smarty' ),
                'params' => array(
                    array(
                    ...
                    array(
                        'type' => 'textfield',
                        'heading' => esc_html__( 'Get shortcode', 'smarty' ),
            ...
            if ( class_exists( 'RevSlider' ) ) {
                ...
                if ( $arrSliders ) {
                    ...
                    $revsliders[ esc_html__( 'No sliders found', 'smarty' ) ] = 0;
                }

                vc_map( array(
                    'name'     => esc_html__( 'Revolution Slider Navigation', 'smarty' ),
                    ...
                    'params'   => array(
                        array(
                            'type'        => 'dropdown',
                            'heading'     => esc_html__( 'Revolution Slider', 'smarty' ),
                            'param_name'  => 'slider_id',
                            'admin_label' => true,
                            'value'       => $revsliders,
                            'description' => esc_html__( 'Select your Revolution Slider.', 'smarty' ),
                        ),
                        array(
                            'type'        => 'textfield',
                            'heading'     => esc_html__( 'Title', 'smarty' ),
                        ...
                        array(
                            'type'       => 'textfield',
                            'heading'    => esc_html__( 'Go To Slide (int)', 'smarty' ),
...
if ( class_exists( 'WPBakeryShortCode' ) ) {
	...
	class WPBakeryShortCode_Stm_Administrator_Contact_Details extends WPBakeryShortCode {}
	class WPBakeryShortCode_Stm_Google_Map extends WPBakeryShortCode {}
	class WPBakeryShortCode_Stm_Contact_Details extends WPBakeryShortCode {}
    ...
    class WPBakeryShortCode_Stm_Administrators extends WPBakeryShortCode {}
    class WPBakeryShortCode_Stm_More extends WPBakeryShortCode {}
	...
	class WPBakeryShortCode_Stm_Mg_Photo extends WPBakeryShortCode {}

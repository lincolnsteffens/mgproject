...
if( class_exists('STM_PostType') ) {
	...
	if( ! function_exists('stm_post_type_init')  ) {
		...
		function stm_post_type_init() {
			...
			STM_PostType::addMetaBox( 'stm_page_title_mb', esc_html__( 'Page title', 'smarty' ), array( 'page', 'stm_teacher', 'stm_event', 'stm_donation', 'stm_course' ), '', '', '', array(
				'fields' => array(
                    ...
                    'stm_page_title_position' => array(
                        'label'   => esc_html__( 'Title - Position', 'smarty' ),
                        'type'    => 'select',
                        'options' => array(
                            'text-left'  => esc_html__( 'Left', 'smarty' ),
                            'text-center'  => esc_html__( 'Center', 'smarty' ),
                            'text-right'  => esc_html__( 'Right', 'smarty' )
                        )
                    ),
			...
			STM_PostType::addMetaBox( 'course_details', esc_html__( 'Details', 'smarty' ), array( 'stm_course' ), '', '', '', array(
				'fields' => array(
                    ...
                    'course_age' => array(
                        'label' => esc_html__( 'Age', 'smarty' ),
                        'type'  => 'text'
                    ),
                    'course_size' => array(
                        'label' => esc_html__( 'Size', 'smarty' ),
                        'type'  => 'text'
                    ),
                    'course_duration' => array(
                        'label' => esc_html__( 'Duration', 'smarty' ),
                        'type'  => 'text'
                    ),
                    'course_price' => array(
    ...
    STM_PostType::addTaxonomy( 'stm_course_category', esc_html__( 'Categories', 'smarty' ), 'stm_course' );
